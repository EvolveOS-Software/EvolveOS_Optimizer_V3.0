...
{
    public class ScriptsFlowPanel : Panel
    {
        ...
        public static readonly DependencyProperty HorizontalSpacingProperty = DependencyProperty.Register(
            nameof(HorizontalSpacing), typeof(double), typeof(ScriptsFlowPanel), new PropertyMetadata(12.5, OnLayoutChanged));

        public static readonly DependencyProperty VerticalSpacingProperty = DependencyProperty.Register(
            nameof(VerticalSpacing), typeof(double), typeof(ScriptsFlowPanel), new PropertyMetadata(10.0, OnLayoutChanged));

        public static readonly DependencyProperty ContentAlignmentProperty = DependencyProperty.Register(
            nameof(ContentAlignment), typeof(HorizontalAlignment), typeof(ScriptsFlowPanel), new PropertyMetadata(HorizontalAlignment.Left, OnLayoutChanged));

        public static readonly DependencyProperty UseMasonryLayoutProperty = DependencyProperty.Register(
            nameof(UseMasonryLayout), typeof(bool), typeof(ScriptsFlowPanel), new PropertyMetadata(true, OnLayoutChanged));

        public static readonly DependencyProperty ItemWidthProperty = DependencyProperty.Register(
            nameof(ItemWidth), typeof(double), typeof(ScriptsFlowPanel), new PropertyMetadata(200.0, OnLayoutChanged));
        ...
        {
            if (d is ScriptsFlowPanel panel)
            {
