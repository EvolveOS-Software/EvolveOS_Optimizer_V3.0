        ...
        return new SettingGroup
        {
            ...
            Settings = new List<SettingDefinition>
            {
                ...
                new SettingDefinition
                {
                    ...
                    Description = "Controls the transparency level of the taskbar. EvolveOS_Optimizer automatically enables Transparency Effects when this setting is applied",
                    GroupName = "Taskbar Behavior",
                    InputType = InputType.Selection,
                    Icon = "Opacity",
                    IsWindows10Only = true,
                ...
                new SettingDefinition
                {
                    Id = "explorer-taskbar-show-seconds",
                    IsSubjectivePreference = true,
                    Name = "Show seconds in system tray clock",
                    Description = "Displays seconds in the clock located in the system tray. Uses slightly more power.",
                    GroupName = "Taskbar Behavior",
                    InputType = InputType.Toggle,
