...
public static class PowerPlanDefinitions
{
    public static readonly List<PredefinedPowerPlan> BuiltInPowerPlans = new List<PredefinedPowerPlan>
    {
        ...
        new("EvolveOS_Optimizer Power Plan", "Optimized power plan for gaming and performance", "PowerPlan_EvolveOSPowerPlan_Name", "57696e68-616e-6365-506f-776572000000")
    };
}
