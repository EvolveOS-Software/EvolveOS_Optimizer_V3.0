    ...
    public static SettingGroup GetGamingAndPerformanceOptimizations()
    {
        return new SettingGroup
        {
            ...
            Settings = new List<SettingDefinition>
            {
                ...
                new SettingDefinition
                {
                    Id = "gaming-performance-os-compression",
                    Name = "OS Compression",
                    Description = "Check your current system compression status, and compact the operating system files to save disk space.",
                    IconPack = "Fluent",
                    Icon = "FolderZip",
                ...
                new SettingDefinition
                {
                    ...
                    InputType = InputType.Toggle,
                    RequiresRestart = true,
                    RecommendedToggleState = false, // Gamers should turn this OFF
                    PowerShellScripts = new List<PowerShellScriptSetting>
                    {
                        new PowerShellScriptSetting
                        {
                            // Toggle ON = Dynamic Tick is ENABLED (Windows Default)
                            EnabledScript = "bcdedit /deletevalue disabledynamictick; bcdedit /deletevalue useplatformclock",
            
                            // Toggle OFF = Dynamic Tick is DISABLED (Best for Gaming)
                            DisabledScript = "bcdedit /set disabledynamictick yes; bcdedit /set useplatformclock false",
                ...
                new SettingDefinition
                {
                    ...
                    RegistrySettings = new List<RegistrySetting>
                    {
                        new RegistrySetting
                        {
                            KeyPath = @"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\AFD\Parameters",
                            ValueName = "FastSendDatagramThreshold",
                ...
                new SettingDefinition
                {
                    ...
                    RegistrySettings = new List<RegistrySetting>
                    {
                        new RegistrySetting
                        {
                            ...
                            RecommendedValue = 0,
                            EnabledValue = [1], // ON means we disable the clearing (faster shutdown)
                            DisabledValue = [0], // OFF means it clears the pagefile (slow shutdown)
                            DefaultValue = 0,
                            ValueType = RegistryValueKind.DWord,
                        },
                    },
                ...
                new SettingDefinition
                {
                    ...
                    RegistrySettings = new List<RegistrySetting>
                    {
                        new RegistrySetting
                        {
                            ...
                            RecommendedValue = 0,
                            EnabledValue = [1], // ON means Large Cache is Disabled
                            DisabledValue = [0], // OFF means Large Cache is Enabled
                            DefaultValue = 0,
                            ValueType = RegistryValueKind.DWord,
                        },
                    },
                ...
                new SettingDefinition
                {
                    ...
                    RegistrySettings = new List<string> { "WdiSystemHost", "WdiServiceHost", "TroubleshootingSvc", "DPS", "wmiApSrv", "pla" }
                        .Select(service => new RegistrySetting
                        {
                            KeyPath = $@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\{service}",
                            ValueName = "Start",
                            RecommendedValue = 4,
                            DefaultValue = 3,
                            ValueType = RegistryValueKind.DWord,
                ...
                new SettingDefinition
                {
                    ...
                    RegistrySettings = new List<string> { "vmicvmsession", "vmictimesync", "vmicshutdown", "vmicrdv", "vmickvpexchange", "vmicheartbeat", "vmicguestinterface", "vmicvss" }
                        .Select(service => new RegistrySetting
                        {
                            KeyPath = $@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\{service}",
                            ValueName = "Start",
                ...
                new SettingDefinition
                {
                    ...
                    RegistrySettings = new List<string> { "AssignedAccessManagerSvc", "AppReadiness", "workfolderssvc", "AppMgmt" }
                        .Select(service => new RegistrySetting
                        {
                            KeyPath = $@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\{service}",
                            ValueName = "Start",
                ...
                new SettingDefinition
                {
                    ...
                    ComboBox = new ComboBoxMetadata
                    {
                        Options = new[]
                        {
                            new ComboBoxOption
                            {
                                DisplayName = "Disabled",
                                ValueMappings = new Dictionary<string, object?> { ["Start"] = 4 },
                                Warning = "Disabling these services will prevent you from seeing other computers on your local network, and will break file/printer sharing.",
                                IsRecommended = true,
                            },
                            new ComboBoxOption
                            {
                    ...
                    RegistrySettings = new List<string> { "lmhosts", "FDResPub", "fdPHost", "LanmanServer" }
                        .Select(service => new RegistrySetting
                        {
                            KeyPath = $@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\{service}",
                            ValueName = "Start",
                            RecommendedValue = 4,
                            DefaultValue = 3, // Defaults vary slightly between these services, but 3/2 is typical
                            ValueType = RegistryValueKind.DWord,
                        }).ToList(),
                },
                #endregion

                #region Scheduled Tasks - Telemetry & Privacy
                new SettingDefinition
                {
                ...
                new SettingDefinition
                {
                    ...
                    {
                        [0] = new Dictionary<string, bool> // Setting VisualFXSetting to 0 doesn't auto-apply hardware defaults.
                                                           // Instead, we apply a custom "Balanced" preset.
                                                           // Note: The Windows GUI won't reflect this accurately. To truly let Windows decide, use the native OS settings.
                        {
                            ["ui-effects"] = false,
