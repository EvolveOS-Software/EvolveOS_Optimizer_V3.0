            ...
            Settings = new List<SettingDefinition>
            {
                ...
                new SettingDefinition
                {
                    ...
                    RegistrySettings = new List<RegistrySetting>
                    {
                        new RegistrySetting
                        {
                            KeyPath = @"HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Policies\Attachments",
                            ValueName = "SaveZoneInformation",
                            RecommendedValue = 2, // 2 = Save zone info
                            EnabledValue = [2, null],
                            DisabledValue = [1],  // 1 = Do not save
                            DefaultValue = 2,
                            ValueType = RegistryValueKind.DWord,
                        }
                    }
                ...
                new SettingDefinition
                {
                    ...
                    RegistrySettings = new List<RegistrySetting>
                    {
                        new RegistrySetting
                        {
                            KeyPath = @"HKEY_CURRENT_USER\Software\EvolveOS_Optimizer\Settings",
                ...
                new SettingDefinition
                {
                    ...
                    Description = "Displays rotating Windows Spotlight images on your lock screen instead of a static background. EvolveOS_Optimizer automatically sets the Start Menu Recommended Section to Show when this setting is enabled as it is required",
                    GroupName = "Lock Screen",
                    IconPack = "Fluent",
                    Icon = "ImageCircle",
                    InputType = InputType.Toggle,
                ...
                new SettingDefinition
                {
                    ...
                    Description = "Displays promotional content, tips, and feature suggestions within the Windows Settings app. EvolveOS_Optimizer automatically sets the Start Menu Recommended Section to Show when this setting is enabled as it is required",
                    GroupName = "General",
                    Icon = "StarCog",
                    InputType = InputType.Toggle,
                    Dependencies = new List<SettingDependency>
                ...
                new SettingDefinition
                {
                    ...
                    RegistrySettings = new List<RegistrySetting>
                    {
                        // Add one for the Master switch or individual groups as needed. Here is the master Policy:
                        new RegistrySetting
                        {
                            KeyPath = @"HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\SettingSync",
                            ValueName = "DisableSettingSync",
                            RecommendedValue = 1,
                            EnabledValue = [0, null],
                            DisabledValue = [2], // 2 forces it off via policy in standard MS docs
                            DefaultValue = null,
                            ValueType = RegistryValueKind.DWord,
                            IsGroupPolicy = true
                        },
                ...
                new SettingDefinition
                {
                    ...
                    RegistrySettings = new List<RegistrySetting>
                    {
                        new RegistrySetting
                        {
                            KeyPath = @"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\diagnosticshub.standardcollector.service",
                            ValueName = "Start",
                            // 4 = Disabled, 3 = Manual (Standard Windows Service state)
                            RecommendedValue = 4,
                            EnabledValue = [3], // Enabling the service sets it to Manual
                            DisabledValue = [4], // Disabling the service sets it to Disabled
                            DefaultValue = 3,
                            ValueType = RegistryValueKind.DWord,
                        },
                    },
                ...
                new SettingDefinition
                {
                    ...
                    Description = "Allow Windows to collect and send additional usage data to the Customer Experience Improvement Program (CEIP)",
                    GroupName = "Diagnostics & Feedback",
                    Icon = "AccountGroup",
                    InputType = InputType.Toggle,
                    RegistrySettings = new List<RegistrySetting>
                    {
                        new RegistrySetting
                        {
                            KeyPath = @"HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\SQMClient\Windows",
                ...
                new SettingDefinition
                {
                    ...
                    RegistrySettings = new List<RegistrySetting>
                    {
                        new RegistrySetting
                        {
                            KeyPath = @"HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\PolicyManager\current\device\System",
                ...
                new SettingDefinition
                {
                    ...
                    RegistrySettings = new List<RegistrySetting>
                    {
                        new RegistrySetting
                        {
                            KeyPath = @"HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Google\Chrome",
                            ValueName = "MetricsReportingEnabled",
                            RecommendedValue = 0,
                            EnabledValue = [1, null],
                            DisabledValue = [0],
                ...
                new SettingDefinition
                {
                    ...
                    RegistrySettings = new List<RegistrySetting>
                    {
                        new RegistrySetting
                        {
                            KeyPath = @"HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Mozilla\Firefox",
