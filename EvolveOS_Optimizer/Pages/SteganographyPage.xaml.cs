...
{
    public sealed partial class SteganographyPage : Page, IPurgeable
    {
        ...
        public SteganographyPage()
        {
            ...
            this.Unloaded += SteganographyPage_Unloaded;
        }
        ...
        private void SteganographyPage_Unloaded(object sender, RoutedEventArgs e)
        {
            _ = Purge();
        }
