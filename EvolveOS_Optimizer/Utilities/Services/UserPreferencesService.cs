...
public class UserPreferencesService : IUserPreferencesService
{
    ...
    private string GetPreferencesFilePath()
    {
        try
        {
            ...
            string appDataPath = _fileSystemService.CombinePath(localAppData, "EvolveOS", "Config");
        ...
        catch (Exception ex)
        {
            ...
            string tempPath = _fileSystemService.CombinePath(_fileSystemService.GetTempPath(), "EvolveOS", "Config");
