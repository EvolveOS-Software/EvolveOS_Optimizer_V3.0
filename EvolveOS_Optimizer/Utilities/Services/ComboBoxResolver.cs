    ...
    ISystemSettingsDiscoveryService discoveryService) : IComboBoxResolver
{
    ...
    #region Asynchronous Value Resolution
    ...
    #region Synchronous Index & Value Mapping
    ...
    #region Helpers
    private static bool ValuesAreEqual(object? value1, object? value2) => ValueComparer.ValuesAreEqual(value1, value2);
    #endregion
}
