...
#
# Add the generated .msix and .cer files to your Visual Studio resources!
# ==============================================================================
  ...
  <Applications>
    <Application Id="EvolveOSOptimizer" Executable="$AppName.exe" EntryPoint="Windows.FullTrustApplication">
      ...
      <Extensions>
        ...
        <!-- 3. MODERN CONTEXT MENU DECLARATION -->
